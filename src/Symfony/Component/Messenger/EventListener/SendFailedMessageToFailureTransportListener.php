...
class SendFailedMessageToFailureTransportListener implements EventSubscriberInterface
{
    ...
    public function __construct(ContainerInterface $failureSenders, ContainerInterface $retryStrategyLocator, ?LoggerInterface $logger = null)
    {
    ...
    {
        if (!$this->retryStrategyLocator->has($transportName)) {
            return null;
        }
